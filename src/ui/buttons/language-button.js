   ...
   return (
      <>
         ...
         <AnimatePresence>
            {open && (
               <motion.ul
                  className="absolute z-10 space-y-1 p-1 mt-3 min-w-[10rem] md:min-w-[12rem] text-2xl md:text-3xl rounded-2xl bg-white dark:bg-primary-300/20 backdrop-blur-2xl border border-quaternary dark:border-primary-300/25 shadow-lg overflow-auto cursor-pointer transition-bg_border"
                  ref={ref}
