...
function PaginationButton({ type, handler, disabled, children }) {
   ...
   return (
      <>
         ...
         <button
            className={`flex items-center gap-1 xs:gap-px hover:bg-accent-400 dark:hover:bg-accent-300/60 hover:border-accent-400 hover:text-white rounded-full p-2 px-3 xs:p-2 pr-4 cursor-pointer hover:shadow-link-btn dark:hover:shadow-link-btn-dark transition ${
