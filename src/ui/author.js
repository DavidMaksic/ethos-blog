...
function Author({ author }) {
   ...
   return (
      <div className="col-span-5 md:col-span-full w-full flex justify-center bg-white dark:bg-primary-300/10 border border-quaternary dark:border-tertiary rounded-3xl px-12 lg:px-10 md:px-14 xs:px-8 py-12 pb-14 mt-6 transition-bg_border font-medium box-shadow">
         <div
