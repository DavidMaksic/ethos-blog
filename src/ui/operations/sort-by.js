...
function SortBy({ options, isBookmarks = false, param }) {
   ...
   return (
      <div className="flex items-center gap-2.5 select-none md:text-2xl">
         ...
         >
            <div
               className="relative px-3 py-[7px] xs:py-[5px] pl-5 cursor-pointer rounded-xl bg-white dark:bg-primary-300/15 dark:hover:bg-primary-100 text-primary-500 border border-tertiary dark:border-primary-300/10 shadow-2xs transition-200"
               onClick={(e) => {
                  e.stopPropagation();
