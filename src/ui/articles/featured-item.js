   ...
   return (
      ...
      >
         <Link
            ...
            className="relative flex flex-col justify-between h-[30rem] lg:h-[25rem] md:h-[20rem] rounded-xl p-10 xl:p-8 lg:p-6 md:p-9 group cursor-pointer hover:translate-y-[-6px] transition duration-300 hover:shadow-2xl dark:hover:shadow-none select-none"
         >
            ...
            <div className="z-20 space-y-1">
               ...
               <h2
                  className={`text-primary dark:text-primary-600/95 text-[2rem] lg:text-[1.6rem] md:text-4xl sm:text-[2rem] font-medium ${cormorantSC.className} leading-9.5 lg:leading-8 md:leading-10`}
