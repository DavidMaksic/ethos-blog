      ...
      >
         ...
         >
            ...
            <div className="z-20 space-y-1">
               ...
               <h2
                  className={`text-primary dark:text-primary-600/95 text-[1.9rem] lg:text-[1.6rem] md:text-4xl sm:text-[2rem] font-medium ${cormorantSC.className} leading-9.5 xl:leading-9 lg:leading-8 md:leading-10`}
