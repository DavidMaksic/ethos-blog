      ...
      <motion.div
         className={`container text-text my-3 [&_:is(h1,h2,h3)]:font-headers ${
            article.language === 'English'
               ? `text-2xl xl:text-[1.325rem] md:text-[1.6rem] [&_p]:leading-[1.49]! xs:[&_p]:leading-[1.4]! lg:[&_blockquote>*]:text-[1.4rem] md:[&_blockquote>*]:text-[1.75rem] xl:[&_blockquote>*]:leading-7.5 lg:[&_blockquote>*]:leading-7.5 md:[&_blockquote>*]:leading-9.5 sm:[&_blockquote>*]:leading-9.5 xs:[&_blockquote>*]:leading-7 ${crimsonText.className}`
