   ...
   return (
      <div
         ...
         className={`container text-text my-3 [&_:is(h2,h3)]:font-secondary ${
            ...
            article.code === 'en'
               ? `text-2xl 2xl:text-[1.326rem] md:text-[1.6rem] [&_p]:leading-[1.49]! xs:[&_p]:leading-[1.35]! [&_blockquote>*]:font-main [&_blockquote>*]:font-semibold [&_blockquote>*]:text-[1.65rem] 2xl:[&_blockquote>*]:text-[1.41rem] lg:[&_blockquote>*]:text-[1.438rem] md:[&_blockquote>*]:text-[1.75rem] xs:[&_blockquote>*]:text-[1.7rem] [&_blockquote>*]:leading-[1.23] 2xl:[&_blockquote>*]:leading-7.5 lg:[&_blockquote>*]:leading-7.5 md:[&_blockquote>*]:leading-9.5 sm:[&_blockquote>*]:leading-9.5 xs:[&_blockquote>*]:leading-[1.29] xs:[&_blockquote]:leading-[1.29] font-article`
