...
function MainArticle({ article }) {
   ...
   return (
      <motion.div
         className={`grid grid-cols-2 md:flex! md:flex-col! gap-10 md:gap-4 mt-24 xl:mt-22 lg:mt-24 sm:mt-14 xs:mt-10 mb-38 xl:mb-33 sm:mb-20 ${cormorantSC.className}`}
         initial={{ opacity: 0 }}
         animate={{ opacity: 1 }}
      ...
      >
         ...
         <div className="relative md:order-1 h-[26rem] xl:h-[23rem] lg:h-[20rem] xs:h-[20rem]">
            <RemoteImage
