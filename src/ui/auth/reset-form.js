...
import ResetPassword from '@/src/ui/auth/reset-password';
      ...
      >
         <AnimatePresence mode="wait" initial={false}>
            <motion.div
               ...
               className="flex flex-col gap-7 px-18 lg:px-14 md:px-18 sm:px-14 3xs:px-10 py-12 lg:py-10 md:py-12 sm:py-11 3xs:py-10 pb-13 lg:pb-11 md:pb-13 sm:pb-12 3xs:pb-11 items-center bg-primary/80 dark:bg-primary/70 md:bg-primary/40 md:dark:bg-primary-300/15 backdrop-blur-lg dark:backdrop-blur-xl md:backdrop-blur-none border border-primary/15 dark:border-primary-400/10 rounded-3xl transition-bg_border shadow-2xl md:dark:shadow-none text-primary-600/90 dark:text-primary-600/60 -translate-y-[18px] lg:translate-y-0 font-secondary"
            >
               <LoginHeader mode={'forgot'} />
               <ResetPassword />
