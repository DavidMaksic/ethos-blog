   ...
   return (
      <>
         {sortedComments?.length ? (
            <motion.div
               className={`max-h-[650px] 2xl:max-h-[36.5rem] lg:max-h-[35.5rem] md:max-h-[48rem] sm:max-h-[67vh] xs:max-h-[70vh] overflow-y-scroll scrollbar rounded-3xl bg-white dark:bg-primary-300/10 border border-quaternary dark:border-primary-300/15 box-shadow ${
