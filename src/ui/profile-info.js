...
function ProfileInfo({ oldUser, newUser }) {
   ...
   return (
      <div className="self-start w-fit flex flex-col items-center gap-6 bg-white dark:bg-primary-300/10 border border-quaternary dark:border-tertiary rounded-3xl px-28 py-20 text-3xl transition-bg_border">
