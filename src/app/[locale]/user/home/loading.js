   ...
   return (
      ...
      >
         <div className="space-y-4">
            <div className="w-[460px] xl:w-[392px] lg:w-[342px] md:w-full h-[24.5rem] xl:h-[25.5rem] lg:h-[20.5rem] md:h-[310px] xs:h-[250px] 2xs:h-[217px] self-start rounded-3xl bg-primary-300/50 px-28 py-20" />
