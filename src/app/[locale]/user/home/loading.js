   ...
   return (
      ...
      >
         <div className="space-y-4">
            <div className="w-[494px] xl:w-[346px] lg:w-[342px] md:w-full h-[24.5rem] xl:h-[22.5rem] lg:h-[20.5rem] md:h-[310px] xs:h-[208px] 2xs:h-[166px] self-start rounded-3xl bg-primary-300/50 px-28 py-20" />
