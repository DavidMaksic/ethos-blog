...
export default function Layout({ children }) {
   return (
      <div className="h-[80dvh] md:min-h-[82dvh] sm:h-auto grid grid-cols-[16rem_1fr] lg:grid-cols-[auto_1fr] sm:grid-cols-1 gap-12 lg:gap-8 md:translate-y-7 sm:translate-none">
         <SideNavigation />
