...
export default async function Page() {
   ...
   return (
      <div className="min-h-screen grid grid-cols-[1fr_1fr] text-xl 2xl:px-60 xl:px-26 inter-padding font-main text-text selection:bg-accent-400/90 dark:selection:bg-accent-200/50 selection:text-white caret-primary-400 antialiased bg-primary transition-200">
         ...
         <Image
            className="block object-cover opacity-95 dark:opacity-80 size-full shadow-xl dark:shadow-none"
            src={loginImg}
            alt="Login image"
            priority={true}
            quality={60}
