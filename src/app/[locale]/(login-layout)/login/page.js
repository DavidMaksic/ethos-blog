      ...
      <>
         <section className="flex justify-center self-center -translate-y-10">
            ...
            >
               ...
               <div className="flex flex-col gap-10 size-fit px-24 lg:px-10 pt-12 pb-14 items-center bg-white dark:bg-primary-300/10 border border-quaternary dark:border-primary-300/15 rounded-2xl transition-bg_border shadow-dashboard dark:shadow-none">
